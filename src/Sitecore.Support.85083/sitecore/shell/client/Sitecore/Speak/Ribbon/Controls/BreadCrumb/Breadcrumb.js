    ...
    Sitecore.Factories.createBaseComponent({
        ...
        renderContextMenu: function (id) {
            ...
            ExperienceEditor.PipelinesUtil.generateRequestProcessor("ExperienceEditor.Breadcrumb.GetChildItems", function (response) {
                ...
                var menuSource = "<nav id='" + menuControlId + "' style='position:fixed;z-index:10000;height:100%;" + positionStyle + "' class=''>" + response.context.currentControl.generateContextMenuHtmlSource(response.responseValue.value) + "</nav>";
